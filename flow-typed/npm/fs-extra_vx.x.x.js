// flow-typed signature: 93eb879c6f5ccd5ae7e663af7f89dbe5
// flow-typed version: <<STUB>>/fs-extra_v^7.0.0/flow_v0.81.0
...
declare module "fs-extra" {
  ...
  declare export function readFile(path: Path): Promise<Buffer>;
  declare export function writeFile(path: Path, content: Buffer): Promise<void>;
